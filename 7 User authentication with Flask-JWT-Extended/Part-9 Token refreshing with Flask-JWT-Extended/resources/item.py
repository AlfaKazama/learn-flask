...
class Item(MethodView):
  ...
  def delete(self, item_id):
    jwt = get_jwt() 
    # jadi get_jwt() memungkinkan kita melihat informasi appaun yang disimpan dalam JWT,
    # dan disni kit amelihat bagian data "is_admin" yang disimpan dalam jwt, dan ini bisa True atau False
...
class itemList(MethodView):
  ...
  # fresh true berarti memerlukan token baru (fresh)
